...
# Create users
User.create([
  {id: 1, first_name: 'Hans', last_name: 'Palacios', email: 'hans@mrperfect.com', username: 'hans', password: 'duckduckgoose'},
  {id: 2, first_name: 'James', last_name: 'Lim', email: 'james@bond.com', username: 'james', password: 'shakennotstirred'},
  {id: 3, first_name: 'Neil', last_name: 'Parsa', email: 'neil@parsa.net',
    username: 'neil', password: 'neilneil'},
  {id: 4, first_name: 'Logan', last_name: 'Baker', email: 'logan@animalhospital.org', username: 'logan', password: 'password'},
